...
🏆  Top5 可直接播放的片源
  ...
  #1  97.5 分   Internet Archive
      ...
      ▶ https://archive.org/download/notld_1968_restored_4k/notld_restored_1080p.mp4
        ...
        码率        12/12  2906 kbps · 1.95 GB，码率理想
        来源可信      12/12  公有领域；收录于 feature_films 馆藏
        人气       7.5/8   412,907 次下载
...
**可播性既是最高权重，也是硬门槛。**
4K 的 MKV 在浏览器里是黑屏，480p 的 MP4 立刻出画面——对"点开就要看"的产品后者才是好片源。
不可播容器直接踢出 Top5 进备选区，而不是靠扣分让它沉底（扣分挡不住 4K MKV 靠清晰度分挤进第一）。
